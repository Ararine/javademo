...
public class Java144_Wrapper {
	//Wrapper 클래스와 auto boxing , auto unboxing || String -> 정수 및 실수 , 정수 및 실수 -> String
	public static void main(String[] args) {
		...
		//int x2 = de;
//		int x2 = de; //auto casting이 발생될 때에만 auto unboxing을 사용할 수 있다.
//		System.out.println(x2);
		...
		String kt = dp.toString(); //Double -> String
